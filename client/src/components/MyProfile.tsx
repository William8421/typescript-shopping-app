    ...
    <div className='myProfile-container'>
      ...
      {isLoggedIn ? (<div>
        <div className='my-info-container' key={userData.id}>
          <div className='info'><span>Username:</span> <span>{userData.username}</span></div>
          <div className='info'><span>First Name:</span> <span>{userData.firstName}</span></div>
          <div className='info'><span>Last Name:</span> <span>{userData.lastName}</span></div>
          <div className='info'><span>Email:</span> <span>{userData.email}</span></div>
        </div>
