...
export default function MyItems() {
  ...
  return (
    <div className='my-items-container'>
      ...
      <AddItemModal isAddItemsOpen={isAddItemsOpen} openCloseAddItemsModal={openCloseAddItemsModal} triggerRefresh={triggerRefresh} />
      <UpdateItem isUpdateItemModalOpen={isUpdateItemModalOpen} openCloseUpdateItemModal={openCloseUpdateItemModal} selectedItem={selectedItem} data={itemsData} triggerRefresh={triggerRefresh} />
      <DeleteItemModal isDeleteItemModalOpen={isDeleteItemModalOpen} openCloseDeleteItemModal={openCloseDeleteItemModal} selectedItem={selectedItem} triggerRefresh={triggerRefresh} />
    </div>
  )
}
